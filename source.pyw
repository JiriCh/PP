...
sql_dict = {
    ...
    'LastPurchase' : {'sql' : 'SELECT Category, Label, Product_desc, Store, Amount, purchases.Product_id, purchases.Unit_price, Total_price, Purchase_time, Identifier, Flag, Payment_type from Purchases LEFT JOIN Stock on stock.Product_id = purchases.Product_id where Category not like "Nájemné" and Purchase_time = (SELECT max(Purchase_time) from purchases)', 'args': None},
    'PurchasesToday' : {'sql' : 'SELECT Category, Label, Product_desc, Store, Amount, purchases.Product_id, purchases.Unit_price, Total_price, Purchase_time, Identifier, Flag, Payment_type from Purchases LEFT JOIN Stock on stock.Product_id = purchases.Product_id where Category not like "Nájemné" and Purchase_time like ?', 'args' : ['%'+sysDate+'%']},
    'PurchasesThisWeek' : {'sql' : 'SELECT Category, Label, Product_desc, Store, Amount, purchases.Product_id, purchases.Unit_price, Total_price, Purchase_time, Identifier, Flag, Payment_type from Purchases LEFT JOIN Stock on stock.Product_id = purchases.Product_id where Category not like "Nájemné" and Purchase_time >= ? and Purchase_time < ?', 'args' : (weekStart, weekEnd)},
    'PurchasesThisMonth' : {'sql' : 'SELECT Category, Label, Product_desc, Store, Amount, purchases.Product_id, purchases.Unit_price, Total_price, Purchase_time, Identifier, Flag, Payment_type from Purchases LEFT JOIN Stock on stock.Product_id = purchases.Product_id where Category not like "Nájemné" and Purchase_time >= ? and Purchase_time < ?', 'args' : (monthStart, monthEnd)},
    'PurchasesLastMonth' : {'sql' : 'SELECT Category, Label, Product_desc, Store, Amount, purchases.Product_id, purchases.Unit_price, Total_price, Purchase_time, Identifier, Flag, Payment_type from Purchases LEFT JOIN Stock on stock.Product_id = purchases.Product_id where Category not like "Nájemné" and Purchase_time >= ? and Purchase_time < ?', 'args' : (pmonthStart, pmonthEnd)},
    'AllPurchases' : {'sql' : 'SELECT Category, Label, Product_desc, Store, Amount, purchases.Product_id, purchases.Unit_price, Total_price, Purchase_time, Identifier, Flag, Payment_type from Purchases LEFT JOIN Stock on stock.Product_id = purchases.Product_id where Category not like "Nájemné"', 'args' : None},
...
class appMW(QMainWindow):
    def __init__(self, parent = None):
        ...
        self.title = 'Aplikace Princezna Pampeliska'
        self.initUI()
